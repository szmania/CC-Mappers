        ...
        for tag_name in required_tags:
            if not faction.find(tag_name):
                ...
                if tag_name == 'General':
                    ...
                    from mapper_tools import unit_management
                    knight_candidate_pool = unit_management._get_candidate_pool_for_tag('Knights', working_pool, general_units, categorized_units, unit_categories, unit_to_training_level)
